...
const PharmacyProduct = () => {
    ...
    return (
                ...
                <div className="card" style={{
                    ...
                    <Table
                        ...
                        extraButton={(item: any) => {
                            return <NavLink to={'/pharmacy-product/' + item?.id} className='btn btn-sm btn-primary'>
                                <FaRegPlusSquare />
                            </NavLink>
                        }}
        ...
        <PharmacyProductAdd
            ...
            setData={setItem} data={item} is_home={true}/>
