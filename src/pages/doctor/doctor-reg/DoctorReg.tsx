...
import { FaAngleDoubleLeft, FaAngleDoubleRight, FaCheckCircle, FaCircle, FaPauseCircle, FaPlayCircle, FaPrint } from 'react-icons/fa';
                ...
                <Content >
                    ...
                    <div className='container-fluid flex-grow-1 py-1 size_16'>
                        <div className="row">
                            ...
                            {data?.id > 0 ?
                                <>
                                    <div className="col-4 border border-3 rounded-3   border-primary p-0 "
                                    ...
                                    >
                                        ...
                                        <div className="p-3">
                                            <div className="d-flex justify-content-between align-items-center border border-3 p-1 border-rounded">
                                        ...
                                        >
                                            <button className='btn btn-primary w-100'><FaCheckCircle size={24} /> Tasdiqlash</button>
                                            <button className='btn btn-primary'><FaPrint size={24} /></button>
                                        </div>

                                    </div>
                                    <div className='col-8'>
                                        <div className="d-flex align-items-center gap-2 position-relative mb-1">
                                            <p
                                                className='mb-0'
                                                style={{
                                                    minWidth: '210px',
                                        ...
                                        <div className="size_16 doctor-form_reg">
                                            <div className="">
                                                <h3 className='text-danger fw-bold mb-0 text-center d-block d-lg-none '>
                                                    {minutes.toString().padStart(2, '0')}: {seconds.toString().padStart(2, '0')}

                                                </h3>
                                                <div className='d-md-block d-lg-flex justify-content-between align-items-center w-100 p-1'>
                                                    <div className='d-flex justify-content-between justify-content-lg-star align-items-center gap-2 mb-1 w-md-100  d-none d-lg-block '>
                                                        <Link to="/" className="btn btn-danger btn-sm m-0" onClick={toggle}>Ortga</Link>
                                                        <p className='m-0 ' >
                                                            Kelgan vaqti: <span className='text-info'>{data?.target ? dateFormat(data?.target?.created_at) : 'Barchasi'}</span>
                                                        </p>
                                                    </div>
                                                    <h3 className='text-danger fw-bold mb-0 text-center d-none d-lg-block'>
                                                        {minutes.toString().padStart(2, '0')}: {seconds.toString().padStart(2, '0')}
                                                    </h3>


                                                    {/* <h3 className='d-none d-lg-block d-xl-block '>
                                        Bemor malumotlari
                                    </h3> */}
                                                    <p className='d-none  d-lg-block  d-xl-block '>Yuklama: <span className='text-info'>Ozi kelgan</span></p>
                                                </div>
                                            </div>
                                            <div className=" overflow-none">
                                                ...
                                                {/* desktopda chiqadi */}
                                                <form onSubmit={handleSubmit(send)} className="row border border-3 rounded-3 p-2 border-primary m-0 d-none d-lg-flex"
                                                    style={
                                                        {
                                                    ...
                                                    <div className="col-3 my-1 ">
                                                        <div className="d-flex gap-4 ">
                                                            <label className="form-label">ID:  {'  '}
                                                                <span className='text-info'>{formatId(data?.person_id)}</span>
                                                            </label>
                                                            <div className='d-flex gap-4' >
                                                                <label className="form-label">Navbat:{' '}     <span className='text-info'>{data?.target?.client_value?.at(0)?.queue_number}</span></label>
                                                                <label className="form-label">Yoshi:{' '}     <span className='text-info'>{calculateAge(data?.data_birth, user?.graph_format_date)}</span></label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="col-4 my-1 d-flex gap-1 ">
                                                        <div className=' d-flex gap-1 w-100'>
                                                            <label className="form-label mt-1">F.I.SH:</label>
                                                            <div className='w-100'>
                                                                <Input type="text" placeholder="Familiyasi"  {...register('first_name')} className=' bold-text' name='first_name'
                                                                />
                                                            </div>
                                                        </div>
                                                        {/* <div className=' d-flex gap-1 w-100' >
                                                <label className="form-label mt-1">Ismi:</label>
                                                <div className='w-100' >
                                                    <Input type="text" className=' bold-text' placeholder="Ismi"  {...register('last_name')} name='last_name'
                                                    />
                                                </div>
                                            </div> */}

                                                    </div>
                                                    <div className="col-5 my-1 d-flex align-items-center gap-1 ">
                                                        <label className="form-label mt-1" style={{
                                                            whiteSpace: 'nowrap'
                                                        }}>Tugulgan sana: </label>
                                                        <div >
                                                            <Input type="date" placeholder="Ismi" className=' bold-text'  {...register('data_birth')} name='data_birth'
                                                                onChange={(e: any) => {
                                                        ...
                                                        >Passport:</label>
                                                        <input type="text" {...register('pass_number')} name='pass_number' className='form-control' />
                                                    </div>
                                                    <div className="col-4 my-1 d-flex align-items-center gap-1">
                                                        ...
                                                        <div className="input-group">
                                                            <div className="input-group-text bold-text">
                                                                +998
                                                            </div>
                                                            <PatternFormat
                                                                format="(##) ###-##-##"
                                ...
                                {errors.phone?.message?.toString() || hasError?.errors?.phone?.toString()}
                                                    ...
                                                    <div className="col-4 my-1 d-flex gap-3 align-items-center">
                                                        <label className="form-label mt-1">Manzil:</label>
                                                        <div className='w-100'>
                                                            <Input type="text" className=' bold-text' placeholder="Familiyasi"  {...register('address')} name='address'
                                                                value={'-'}

                                                            />
                                                        </div>
                                                    </div>
                                                    <div className="col-2 my-1 d-flex gap-3 align-items-center">
                                                        {/* <label className="form-label">Nogirnligi: </label>
                                        <div className="d-flex gap-2">
                                            <button className='btn btn-sm btn-success'>Bor</button>
                                            <button className='btn btn-sm btn-danger'>Yo'q</button>
                                        </div> */}

                                                        {/* <div className="d-flex gap-3">
                                <div className="form-check ">
                                    <input className="form-check-input" type="radio" id="male" {...register('sex')} name='sex' value={'male'} />
                                    <label className="form-check-label" htmlFor="male"> Ha </label>
                                </div>
                                <div className="form-check ">
                                    <input className="form-check-input" type="radio" id="female" {...register('sex')} name='sex' value={'female'} />
                                    <label className="form-check-label" htmlFor="female"> Yo'q </label>
                                </div>
                            </div> */}
                                                    </div>
                                                ...
                                                <div className="row my-2 d-none d-lg-flex  " style={{
                                                    // transform: 'translateY(-1.2rem)',
                                                }}>

                                                    <div className="col-3   d-flex gap-3 align-items-center">
                                                        {/* <button className='btn btn-primary'> Xizmatlar</button> */}
                                                            ...
                                                            <div className="w-100">
                                                                <Select
                                                                    ...
                                                                    onChange={(e: any) => {
                                                                        ...
                                                                        //     department_id: e
                                                                        // })
                                                                        allShow(id, false, e.value)


                                                                    }}
                                                                    className="basic-multi-select"
                                                                    classNamePrefix="select"
                                                                    placeholder={"Tibbiy ko'rik tanlang "}
                                                                    // value={userBranch}
                                                                    options={
                                                                        [
                                                                            {
                                                    ...
                                                    <div className="col-2 my-2 d-flex gap-1 align-items-center">
                                                        <label className="form-label" > Tashriflar  : <span className='text-info'>{data?.client_item?.length}</span></label>
                                                        {/* <label className="form-label">Tashriflar sanasini tanlang</label> */}
                                                        <input type="hidden" {...register('department_id')} name='department_id' />
                                    ...
                                    <div className="col-3 ">
                                        ...
                                        <button className='btn btn-warning'>
                                            Fayllar
                                                ...
                                                <div className={`row d-none d-lg-flex ${!user?.is_shikoyat && !user?.is_diagnoz ? 'd-none' : ''}  `}>
...

                                                    {
                                                        +user?.is_diagnoz ?
                                                            <div className="col-6 mb-1">
                                                                <label className="form-label">Diagnoz</label>
                                                                <input type="hidden" {...register('department_id')} name='department_id' />
                                                                <div className="d-flex">
                                                                    <div className="w-100">
                                                                        <Select
                                                ...
                                                <div className="col-3 d-none my-2 d-lg-block">
...

                                                        {
                                                            ...
                                                            +departmentTarget?.value > 0 ?
                                                                <>
                                                                    <div >
                                                                        <button type="button"
                                                                            id='corusel__btn' className={`btn ${dateTargetId === 0 ? 'btn-primary' : 'border-primary'}`}
                                                                            onClick={() => {
                                                                                setDateTargetId(0)
                                                                                // setTemplateResult(() => [])
                                                                                // setTimeout(() => {
                                                                                //     setTemplateResult(() => data?.target)
                                                                                // }, 0);
                                                                                // setTargetTemplate(res?.id)
                                                                            }}
                                                                        >Barchasi</button>
                                                                    ...
                                                                    {data?.client_item
                                                                        ?.map((res: any) => (
                                                                            <div >
                                                                                <button type="button"
                                                                                    id='corusel__btn' className={`btn   ${dateTargetId === res?.id ? 'btn-primary' : 'border-primary'}`}
                                                                                    onClick={() => {
                                                                                        setDateTargetId(res.id)
                                                                                        // setTemplateResult(() => [])
                                                                                        // setTimeout(() => {
                                                                                        //     setTemplateResult(() => data?.target)
                                                                                        // }, 0);
                                                                ...
                                                                <>
                                                                    {
                                                                        +user?.is_editor > 0 ?
                                                                            <div>
                                                                                <button type="button"
                                                                                    id='corusel__btn' className={`btn ${crkRole ? 'btn-primary' : 'border-primary'}`}
                                                                                    onClick={() => {
                                                                                        setCrkRole(true)
                                                                                    }}
                                                                                >Matn uchun</button>
                                                                    ...
                                                                    {user?.department?.department_template_item?.map((res: any) => (
                                                                        <div >
                                                                            <button type="button"



                                                                                id='corusel__btn' className={`btn   ${!crkRole && targetTemplate === res?.id ? 'btn-primary' : 'border-primary'}`}
                                                                                onClick={() => {
                                                                                    setCrkRole(false)
                                                                                    // setTemplateResult(() => [])
                                                                                    // setTimeout(() => {
