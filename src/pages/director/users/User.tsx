...
import UserSettingCashReg from './UserSettingCashReg'
  ...
  return (
    <Content loading={load}>
      ...
      <div className="container-fluid flex-grow-1 container-p-y size_16 ">
        <div className="d-block my-2 gap-3 d-lg-flex">
          <form className='w-100 d-none d-lg-flex gap-3'>
            <div className="w-50">
              <Select
                name='name'
                value={search?.role}
          ...
          <div className='d-block d-lg-flex w-100 w-lg-auto justify-content-center align-items-center gap-1'>
            {
              checkData?.length > 0 ?
