...
import MaterialProductRepotShow from './MaterialProductRepotShow'

const MaterialProductRepot = () => {
    ...
    const getData = async (data: any) => {
        try {
            setLoad(() => true)
            let res = await axios.get(`/material-expense/repot?start_date=${data?.start_date}&end_date=${data?.end_date}`)
            ...
            <div className="container-fluid flex-grow-1 container-p-y size_16 ">
                ...
                <div className="card" style={{
                    ...
                    <Table
                        ...
                        reloadData={true}
                        reloadDataFunction={() => {
                            getData({ ...data, start_date: '', end_date: '' })
                        }}
                        top={100}
                        scrollRole={true}
...
export default MaterialProductRepot