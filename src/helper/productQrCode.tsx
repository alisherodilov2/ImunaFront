...
export const productQrCode = async ({ target, iframeRef }: {
    target
    ?: any,
    iframeRef?: any,
    ...
    try {
        ...
        doc.setLineWidth(1);
        // y = y + 4
        doc.rect(3, y - 3, pageWidth - 23, 30);
        doc.addImage(target?.qr_code_link, "PNG", 3, y - 3, pageWidth - 23, 30);
        ...
        doc.setFontSize(10);
        doc.setFont('regular');
        doc.text(`${dateFormat(target?.created_at)}`,5, (y - 3)+30+5)
